...
public class NovelWriter2 : MonoBehaviour
{
    public GameObject messagePanel;
    public GameObject NextButtun;
    public GameObject Ore;
    public GameObject Aibou;
    public GameObject OkuzyouDoor;
    public GameObject Okuzyou;
    public GameObject OkuzyouZihanki;
    public GameObject OkuzyouZihankiOku;
    public GameObject ZihankiHuta;
    public Text text;
    public Text serih1;
    public Text serih2;
    public GameObject Serih;
    public float writeSpeed = 0.2f;
    public bool isWriting = false;
    public int key = 0;
    private bool isHuta = false;
